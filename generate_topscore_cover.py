...
add_centered("TopScore", 26, True, 6) # Substantial size for main title
add_centered("Quiz Management System", 16, False, 40)
...
# Large custom image for the quiz system at bottom
p_img2 = doc.add_paragraph()
p_img2.alignment = WD_ALIGN_PARAGRAPH.CENTER
custom_img = r"C:\Users\asus\.gemini\antigravity\brain\5b7a5f9e-9964-41df-984b-cd5ecea769f7\topscore_logo_1774372236461.png"

if os.path.exists(custom_img):
    try:
        from PIL import Image
        img = Image.open(custom_img).convert("RGBA")
        true_png = r"c:\Users\asus\budgetbeam\topscore_true.png"

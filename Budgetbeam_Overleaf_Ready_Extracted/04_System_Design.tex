...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{login_ui.png}
    \caption{Budgetbeam Secured Login Interface}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{register_ui.png}
    \caption{Budgetbeam Account Registration}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{forgot_password_ui.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{dashboard_ui.png}
    \caption{Budgetbeam Live Dashboard Interface}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{wallet_ui.png}
    \caption{Secure Wallet Payment Interface}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{calendar_ui.png}
    \caption{Interactive Expense Calendar Interface}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{settings_ui.png}
...
\includegraphics[width=0.85\textwidth]{class.png}
